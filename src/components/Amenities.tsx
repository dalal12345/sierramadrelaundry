...
const AMENITIES = [
  {
    ...
    description: 'Enjoy the sunny Sierra Madre mountain views & fresh air in our outdoor shaded seating patio while your wash runs.',
    tag: 'Popular Feature'
  },
  {
    icon: Wifi,
    title: 'Free High-Speed Wi-Fi',
    description: 'Stay productive or stream your favorite shows with our complimentary ultra-fast Wi-Fi network.',
    tag: 'Gigabit Speed'
  },
  {
    icon: CreditCard,
    title: 'Touchless Mobile & Card Pay',
    description: 'No quarters needed! Use your credit card, Apple Pay, Google Pay, crisp dollar bills, or loyalty card.',
    tag: '100% Touchless'
  },
  {
    icon: Wind,
    title: 'Air Conditioned & Clean',
    description: 'Spacious, climate-controlled interior with comfortable seating, clean folding tables, and bright lighting.',
    tag: 'Climate Controlled'
  },
  {
    icon: Coffee,
    title: 'Snack & Supply Vending',
    description: 'Cold sodas, snacks, and brand-name laundry soaps, softeners, and bleach available right on-site.',
    tag: 'Convenient'
  },
  {
    icon: Car,
    title: 'Free Dedicated Parking Lot',
    description: 'Hassle-free parking right in front of our entrance, making loading and unloading heavy baskets effortless.',
    tag: 'Free Off-Street'
  }
]
...
export function Amenities() {
  return (
    <section id="amenities" className="py-16 md:py-24 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <p className="text-base sm:text-lg text-slate-300">
            We’ve created a clean, safe, and modern environment so doing laundry feels like a breeze.
          </p>
        </div>
