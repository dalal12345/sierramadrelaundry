...
export function ContactSection() {
  ...
  const [formData, setFormData] = useState({ name: '', phone: '', service: 'Self Service', message: '' })
  ...
  return (
    <section id="location" className="py-16 md:py-24 bg-slate-100/60 dark:bg-slate-900/40 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white">
            Located in <span className="text-sky-600 dark:text-cyan-400">Sierra Madre, California</span>
          </h2>
          <p className="text-base text-slate-600 dark:text-slate-300">
            Open 24 hours a day, 7 days a week. Free dedicated parking right at our front door.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-lg text-slate-900 dark:text-white">Our Address</h3>
              ...
              <div className="flex items-start gap-4 pt-4 border-t border-slate-200/60 dark:border-slate-800/60">
                ...
                <div>
                  <h3 className="font-heading font-bold text-lg text-slate-900 dark:text-white">Operating Hours</h3>
                  <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">
                    <strong className="text-emerald-600 dark:text-emerald-400">Open 24/7</strong> — Self-Service Laundry <br />
                    Attendants on site during daytime hours for Fluff & Fold drop-offs.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 pt-4 border-t border-slate-200/60 dark:border-slate-800/60">
                ...
                <div>
                  <h3 className="font-heading font-bold text-lg text-slate-900 dark:text-white">Phone & Contact</h3>
                  <a 
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Call anytime for inquiries or commercial quotes</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-6 glass-panel p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800">
            ...
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 mb-6">
              Have a question about our machines, commercial rates, or drop-off service? Drop us a message below!
            </p>

            {submitted ? (
              <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-center space-y-3">
                <CheckCircle2 className="size-10 text-emerald-500 mx-auto animate-bounce" />
                <h4 className="font-heading font-bold text-lg text-emerald-700 dark:text-emerald-300">Message Received!</h4>
                <p className="text-xs text-slate-600 dark:text-slate-300">
                  Thank you for reaching out to Sierra Madre Laundry. We will reply to your phone or email shortly!
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/70 text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-sky-500"
                  >
                    <option value="Self Service">24/7 Self Service Laundromat</option>
                    <option value="Fluff & Fold">Fluff & Fold Drop-off Service</option>
                    <option value="Pickup & Delivery">Pickup & Delivery Service</option>
                    <option value="Commercial">Commercial Account (Airbnb/Gym/Hotel)</option>
                  </select>
                </div>
                ...
                <Button type="submit" size="lg" className="w-full bg-sky-600 hover:bg-sky-500 text-white font-bold py-6 rounded-xl shadow-md shadow-sky-600/20">
