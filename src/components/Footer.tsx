		...
		<footer className="bg-slate-950 text-slate-400 text-sm border-t border-slate-800 pt-16 pb-12">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
					...
					<div className="space-y-4">
						...
						<p className="text-xs text-slate-400 leading-relaxed">
							Sierra Madre's premier 24/7 self-service laundromat and
							eco-cleaners. Featuring high-capacity Speed Queen washers, mobile
							card pay, outdoor patio, & free Wi-Fi.
						</p>
					</div>
					...
					<div className="space-y-3">
						...
						<a
							...
							className="text-xs font-bold text-cyan-400 hover:underline block"
						>
							Call: (626) 355-6213
						</a>
					</div>
				...
				<div className="pt-8 border-t border-slate-900 text-center text-xs text-slate-500">
					<p>
						© {new Date().getFullYear()} Sierra Madre Laundry. All rights
						reserved. Formerly Drop A Load Laundry.
					</p>
				</div>
			</div>
		</footer>
