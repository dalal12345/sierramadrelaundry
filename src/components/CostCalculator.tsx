...
export function CostCalculator() {
	...
	// Calculations
	const basePrices = {
		self: { small: 4.25, medium: 5.75, large: 9.75, commercial: 14.5 },
		dropoff: { small: 18.0, medium: 32.0, large: 55.0, commercial: 85.0 },
		delivery: { small: 28.0, medium: 45.0, large: 75.0, commercial: 110.0 },
	};

	const dryPrices = { self: 1.5, dropoff: 0, delivery: 0 };
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
					...
					<h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">
						Plan Your Wash & Estimate{" "}
						<span className="text-emerald-600 dark:text-emerald-400">
							Exact Cost
						</span>
					</h2>
					<p className="text-base text-slate-600 dark:text-slate-300">
						Select your load size and service option below to see transparent
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
					...
					<div className="lg:col-span-7 glass-panel p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-8">
						...
						<div>
							<span className="block font-heading font-bold text-sm text-slate-900 dark:text-white mb-3">
							...
							<div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
								{[
									...
									<button
										...
										onClick={() =>
											setLoadSize(
												item.id as "small" | "medium" | "large" | "commercial",
											)
										}
					...
					<div className="lg:col-span-5 glass-panel p-6 sm:p-8 rounded-3xl border border-sky-500/30 dark:border-sky-500/20 shadow-xl bg-gradient-to-b from-sky-500/5 to-teal-500/5">
						...
						<a href="tel:+16263556213" className="w-full">
							<Button
								type="button"
								size="lg"
								className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-6 rounded-2xl shadow-lg shadow-emerald-600/20"
							>
