				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
					...
					<a href="/" className="flex items-center gap-3 group">
						<div className="size-11 rounded-2xl bg-gradient-to-tr from-sky-600 via-cyan-500 to-teal-400 p-0.5 shadow-md shadow-sky-500/20 group-hover:scale-105 transition-transform">
							<div className="w-full h-full bg-slate-900 rounded-[14px] flex items-center justify-center">
								<WashingMachine className="size-6 text-cyan-400" />
							</div>
						</div>
						<div>
					...
					<nav className="hidden lg:flex items-center gap-6 font-medium text-sm">
						<button
							...
							className="text-slate-600 dark:text-slate-300 hover:text-sky-600 dark:hover:text-cyan-400 transition-colors flex items-center gap-1 cursor-pointer bg-transparent border-0 p-0"
						>
						...
						<button
							...
							className="text-slate-600 dark:text-slate-300 hover:text-sky-600 dark:hover:text-cyan-400 transition-colors cursor-pointer bg-transparent border-0 p-0"
						>
							Services
						</button>
						<button
					...
					<div className="hidden sm:flex items-center gap-3">
						...
						>
							<Button
								...
								variant="outline"
								size="sm"
								className="gap-1.5 border-sky-500/30 text-sky-700 dark:text-sky-300 hover:bg-sky-500/10"
							>
						...
						<a href="tel:+16263556213">
							<Button
								type="button"
								size="sm"
								className="gap-1.5 bg-gradient-to-r from-sky-600 to-cyan-600 hover:from-sky-500 hover:to-cyan-500 text-white shadow-md shadow-sky-600/20"
							>
				...
				<div className="lg:hidden bg-slate-900 text-slate-100 border-b border-slate-800 px-6 py-6 space-y-4 animate-in slide-in-from-top duration-200">
					<nav className="flex flex-col space-y-3 font-medium">
						<button
							type="button"
							onClick={() => scrollToSection("live-tracker")}
							className="flex items-center gap-2 text-sky-400 py-1 text-left cursor-pointer bg-transparent border-0"
						>
						...
						<button
							type="button"
							onClick={() => scrollToSection("services")}
							className="py-1 text-left hover:text-sky-400 cursor-pointer bg-transparent border-0"
						>
							Services
						</button>
						<button
