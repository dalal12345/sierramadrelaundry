...
const AREAS = [
	{
		...
		zip: "91024",
		desc: "Home of Sierra Madre Laundry — 24/7 Self-Service & Local Pickup",
	},
	{
		city: "Pasadena, CA",
		zip: "91101 - 91109",
		desc: "Serving East Pasadena, Old Town, & Hastings Ranch communities",
	},
	{
		city: "Arcadia, CA",
		zip: "91006 - 91007",
		desc: "Convenient laundry pickup & express drop-off service",
	},
	{
		city: "Monrovia, CA",
		zip: "91016",
		desc: "Full laundry pickup & commercial laundry accounts",
	},
	{
		city: "Altadena, CA",
		zip: "91001",
		desc: "Residential fluff & fold and self-service access",
	},
	{
		city: "San Marino, CA",
		zip: "91108",
		desc: "Premium white-glove laundry drop-off & delivery",
	},
	{
		city: "Alhambra, CA",
		zip: "91801",
		desc: "Commercial & residential laundry service coverage",
	},
	{
		city: "Duarte, CA",
		zip: "91010",
		desc: "Fast turn-around wash, dry, and fold service",
	},
];
				...
				<div className="text-center max-w-3xl mx-auto space-y-4 mb-14">
					...
					<h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">
						...
						<span className="text-sky-600 dark:text-cyan-400">
							Sierra Madre & Neighboring Cities
						</span>
					</h2>
					<p className="text-base text-slate-600 dark:text-slate-300">
						Our 24/7 laundromat is located in Sierra Madre, with pickup and
						delivery available across all surrounding communities.
					</p>
				</div>
					...
					{AREAS.map((item) => (
						...
						>
							<div className="flex items-center justify-between mb-2">
								...
								<MapPin
									className={`size-4 ${selectedCity.city === item.city ? "text-white" : "text-sky-500"}`}
								/>
							</div>
							<span
								className={`text-xs font-semibold block ${selectedCity.city === item.city ? "text-sky-100" : "text-slate-500 dark:text-slate-400"}`}
							>
								ZIP: {item.zip}
							</span>
						</button>
				...
				<div className="glass-panel p-6 sm:p-8 rounded-3xl border border-sky-500/30 flex flex-col md:flex-row items-center justify-between gap-6">
					<div className="space-y-2 text-center md:text-left">
						...
						<p className="text-sm text-slate-600 dark:text-slate-300 max-w-xl">
							{selectedCity.desc}. Visit our 24/7 facility or contact us to
					...
					<div className="flex items-center gap-3 shrink-0">
						<a href="tel:+16263556213">
							<Button
								type="button"
								size="lg"
								className="bg-sky-600 hover:bg-sky-500 text-white font-semibold rounded-xl"
							>
