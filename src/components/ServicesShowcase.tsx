...
const SERVICES = [
  {
    ...
    badge: 'Open 24/7/365',
    description: 'Experience brand-new, high-efficiency Speed Queen washers and dryers ranging from 20 lb to 80 lb capacity. Pay easily with credit card, Apple Pay, mobile app, or dollar bills.',
    highlights: [
  ...
  },
  {
    ...
    description: 'Drop your laundry off with our friendly on-site staff. We sort, wash with premium detergents, dry, and neatly fold your clothes into ready-to-store bundles.',
    highlights: [
  ...
  },
  {
    ...
    description: 'Save hours every week! We pick up your dirty laundry right from your doorstep in Sierra Madre, Pasadena, Arcadia, and nearby towns, and return it fresh and folded.',
    highlights: [
  ...
  },
  {
    ...
    badge: 'B2B & Wholesale',
    description: 'Custom bulk washing services designed for Airbnb hosts, boutique hotels, spas, fitness gyms, restaurants, and medical offices with reliable scheduled pickup.',
    highlights: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white">
            Everything You Need For <span className="bg-gradient-to-r from-sky-600 to-teal-500 bg-clip-text text-transparent">Fresh, Spotless Laundry</span>
          </h2>
          <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300">
            Whether you want to wash your own clothes in our 24/7 laundromat, drop them off for Fluff & Fold, or have us pick them up at your home or business.
          </p>
        </div>
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between gap-4 mb-6">
                    <div className={`size-14 rounded-2xl bg-gradient-to-tr ${service.color} p-0.5 shadow-md shadow-sky-500/20 group-hover:scale-105 transition-transform`}>
                ...
                <div className="pt-4 border-t border-slate-200/60 dark:border-slate-800/60">
                  <a href="#location">
                    <Button variant="outline" className="w-full justify-between group-hover:bg-sky-600 group-hover:text-white group-hover:border-sky-600 transition-all text-sm font-semibold rounded-xl">
